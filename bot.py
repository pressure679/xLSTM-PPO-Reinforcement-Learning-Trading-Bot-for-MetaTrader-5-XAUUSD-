    ...
    try:
        while True:
            ...
            for i in range(SEQ_LEN, len(df)):
                ...
                # if action == 1 and df["EMA7_Slope"].iloc[i] > 0:
                if action == 1:
                    in_position = True
                    position_type = "long"
                ...
                # elif action == 2 and df["EMA7_Slope"].iloc[i] < 0:
                elif action == 2:
                    in_position = True
                    position_type = "short"
    ...
    while True:
        ...
        if current_m1 != last_m1:
            ...
            if open_pos == 0:
                ...
                # if action == 1 and df["EMA7_Slope"].iloc[-1] > 0:
                if action == 1:
                ...
                # elif action == 2 and df["EMA7_Slope"].iloc[-1] < 0:
                if action == 2:
